...
import './VanAdvertisingPricesPage.css';

const VanAdvertisingPricesPage = () => {
  ...
  // Get data from navigation state (from VanSellerContactPage)
  ...
  const packages = [
    {
      ...
      durationDays: 14,
      color: '#CD7F32',
      description: 'Our Bronze package gets your van listed for up to 2 weeks.',
      features: [
        'Attract buyers - Display your van\'s best features with up to 100 photos.',
    ...
    },
    {
      ...
      durationDays: 21,
      color: '#C0C0C0',
      description: 'Our second best package. Your van listed for up to 3 weeks.',
      features: [
        'Attract buyers - Display your van\'s best features with up to 100 photos.',
        'Stand out with photos in search results.',
    ...
    },
    {
      ...
      durationDays: 28,
      color: '#FFD700',
      description: 'Our Gold package keeps your van listing live for up to 4 weeks.',
      features: [
        'Attract buyers - Display your van\'s best features with up to 100 photos.',
        'Stand out with photos in search results.',
  ...
  const handleCreateAd = () => {
    ...
    navigate(`/vans/sell-your-van?${params.toString()}`);
  };

  return (
    <div className="van-advertising-prices-page">
      <div className="container">
        ...
        <div className="page-header">
          <h1>Choose Your Van Advertising Package</h1>
          <p className="page-subtitle">
            Get maximum exposure for your van with our tailored advertising packages. 
              ...
              <div className="card-body">
                ...
                {user ? (
                  ...
                  <button 
                    ...
                    onClick={() => navigate('/signin', { state: { returnTo: '/vans/advertising-prices' } })}
                  >
                    Sign in to Select
                  </button>
                )}
        ...
        <div className="promotion-section">
          <h2>Why Advertise Your Van With Us?</h2>
          
          <div className="promotion-features">
            <div className="feature-item">
              <div className="feature-icon">
                <svg width="60" height="60" viewBox="0 0 24 24" fill="#2196F3">
                  <path d="M18 18.5c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zM19.5 9.5l1.5 4.5h-3l-1.5-4.5h3zM6 18.5c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zM20 8l3 9v3c0 .55-.45 1-1 1h-1c-.55 0-1-.45-1-1v-1H4v1c0 .55-.45 1-1 1H2c-.55 0-1-.45-1-1v-3l3-9c.33-1 1.33-2 2.5-2h11c1.17 0 2.17 1 2.5 2zM4 14h16l-2-6H6l-2 6z"/>
                </svg>
              </div>
              <h3>Van Specialists</h3>
              <li>Dedicated platform for commercial vehicles</li>
              <li>Targeted audience reach</li>
              <li>Expert van listings</li>
            </div>
            ...
            <div className="feature-item">
              ...
              <li>Thousands of active van buyers</li>
              <li>Daily searches for vans</li>
...
export default VanAdvertisingPricesPage;
