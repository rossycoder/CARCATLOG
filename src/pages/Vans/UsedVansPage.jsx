...
const VAN_BRANDS = [
  'Ford', 'Mercedes-Benz', 'Volkswagen', 'Renault', 'Peugeot', 'Citroen', 
  'Vauxhall', 'Fiat', 'Iveco', 'MAN', 'Toyota', 'Nissan'
];
...
const UsedVansPage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      setFeaturedVans(vansResult.data?.vans || vansResult.data || []);
    } catch (error) {
                ...
                {featuredVans.map(van => (
                  ...
                  >
                    ...
                    <div className="van-details">
                      ...
                      {van.vanType && <p className="van-type">{van.vanType}</p>}
        ...
        <div className="container">
          ...
          <div className="benefits-grid">
            ...
            <div className="benefit-card">
              <span className="benefit-icon">🔍</span>
              <h3>More Choice</h3>
              <p>Access to a wider range of models and specifications.</p>
            </div>
            <div className="benefit-card">
              <span className="benefit-icon">✅</span>
