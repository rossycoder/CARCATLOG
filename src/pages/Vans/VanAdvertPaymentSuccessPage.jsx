...
import './VanAdvertPaymentSuccessPage.css';

const VanAdvertPaymentSuccessPage = () => {
  ...
  useEffect(() => {
    if (sessionId) {
      ...
      // AUTO-COMPLETE: Automatically activate van after payment success
      // This bypasses webhook requirement for localhost development
  ...
  const autoCompletePurchase = async () => {
    try {
      ...
      console.error('❌ Error auto-completing purchase:', err);
    }
  };
  ...
  if (isLoading) {
    return (
      <div className="van-advert-payment-success-page">
      ...
      <div className="container">
        <div className="success-card">
          ...
          <p className="success-message">
            Your {packageName || 'van advertising package'} has been purchased successfully.
          </p>
...
export default VanAdvertPaymentSuccessPage;
