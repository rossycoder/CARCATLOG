        ...
        <div className="detail-container">
          ...
          <div className="page-header-row">
            ...
            <div className="page-action-icons">
              ...
              {/* Share Dropdown Menu - Positioned below share button */}
              {showShareMenu && (
              ...
              <div className="spec-grid">
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/mileage.png" alt="Mileage" style={{ width: '32px', height: '32px' }} />
                  </span>
                ...
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/registration.jpeg" alt="Registration" style={{ width: '40px', height: '40px' }} />
                  </span>
                  <div className="spec-details">
                ...
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/fuel-type.jpeg" alt="Fuel type" style={{ width: '32px', height: '32px' }} />
                  </span>
                  <div className="spec-details">
                ...
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/body-type.jpeg" alt="Body type" style={{ width: '40px', height: '40px' }} />
                  </span>
                  <div className="spec-details">
                ...
                {(!isElectricOrPluginHybrid(car.fuelType) || car.fuelType.toLowerCase().includes('plug-in')) && (
                  <div className="spec-item">
                    <span className="spec-icon">
                      <img src="/icon/engine-size.jpeg" alt="Engine size" style={{ width: '40px', height: '40px' }} />
                    </span>
                    <div className="spec-details">
                ...
                {isElectricOrPluginHybrid(car.fuelType) && (
                  <div className="spec-item">
                    <span className="spec-icon">
                      <img src="/icon/electric-range.jpeg" alt="Electric Range" style={{ width: '40px', height: '40px' }} />
                    </span>
                    <div className="spec-details">
                ...
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/gearbox.jpeg" alt="Gearbox" style={{ width: '40px', height: '40px' }} />
                  </span>
                  <div className="spec-details">
                ...
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/doors.jpeg" alt="Doors" style={{ width: '40px', height: '40px' }} />
                  </span>
                  <div className="spec-details">
                ...
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/seats.jpeg" alt="Seats" style={{ width: '40px', height: '40px' }} />
                  </span>
                  <div className="spec-details">
                ...
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/body-color.jpeg" alt="Body colour" style={{ width: '40px', height: '40px' }} />
                  </span>
                  <div className="spec-details">
                ...
                <div className="spec-item">
                  <span className="spec-icon">
                    <img src="/icon/mot-due.jpeg" alt="MOT Due" style={{ width: '40px', height: '40px' }} />
                  </span>
                  <div className="spec-details">
                  ...
                  <div className="additional-running-costs">
                    <div className="fuel-economy-grid">
                      ...
                      {car.runningCosts.fuelEconomy.extraUrban && (
                        <div className="fuel-economy-item">
                          <span className="fuel-icon">
                            <img src="/icon/running cost/extraurabanmg.jpeg" alt="Extra Urban MPG" />
                          </span>
                          <div className="fuel-details">
