...
/**
 * Update advert (stores temporarily, not in database until payment)
 */
const updateAdvert = async (req, res) => {
  try {
    ...
    // Store update data temporarily in session/memory
    // This will be saved to database only after successful payment
    console.log(`📝 Updating temporary advert data: ${advertId} (not saved to DB yet)`);
    ...
    res.json({
      success: true,
      data: advert,
      message: 'Data will be saved after payment confirmation'
    });
  } catch (error) {
